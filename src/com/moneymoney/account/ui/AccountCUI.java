...
public class AccountCUI {
	...
	private static void selectOptionsToUpdate(int select,
		...
		switch(select){
			...
			case 1:
				...
				try {
					...
					if(name==true){
						System.out.println("Name Changed for "+savingsAccount.getBankAccount().getAccountNumber()+" to "+changeName);
					}
			...
			case 2:
				...
				try {
					...
					if(salary==true){
						System.out.println("Salary type of "+savingsAccount.getBankAccount().getAccountNumber()+"Changed to "+changeSalaryType);
					}
				} catch (ClassNotFoundException | SQLException e) {
					e.printStackTrace();
				}
			...
			case 3:
				...
				try {
					...
					salaryResult = savingsAccountService.updateAccount(savingsAccount);
					if(salaryResult==true){
						System.out.println("Name and Salary type for "+savingsAccount.getBankAccount().getAccountNumber()+" Changed to "+changename+" and "+changeTypeOfSalary);
				}
				} catch (ClassNotFoundException | SQLException e) {
					e.printStackTrace();
				}
	...
	private static void searchAccount() throws ClassNotFoundException, SQLException, AccountNotFoundException {
	...
	private static void seachUsingAccountNumber() throws ClassNotFoundException, SQLException, AccountNotFoundException {
	...
	private static void searchUsingAccountHolderName() throws ClassNotFoundException, SQLException, AccountNotFoundException {
	...
	private static void checkBalance() throws ClassNotFoundException, SQLException, AccountNotFoundException {
	System.out.println("Enter account NUmber");
	int accountNumber=scanner.nextInt();
	...
	private static void sortMenu() throws ClassNotFoundException, SQLException {
		...
		case 1:
			...
			break;
		case 2:
			savingsAccountList = savingsAccountService.sortBySalriedType();
			for (SavingsAccount savingsAccount : savingsAccountList) {
				System.out.println(savingsAccount);
			}
			break;
